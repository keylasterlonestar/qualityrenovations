...
export default function MobileBottomNav() {
  ...
  return (
    <div className="mobile-bottom-nav">
      <a href="tel:2104144166" className="mobile-bottom-nav-item">
      ...
      <button className="mobile-bottom-nav-item mobile-bottom-nav-cta" onClick={() => navigate('/quote')}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <a href="https://www.facebook.com/QualityRenovators/" target="_blank" rel="noreferrer" className="mobile-bottom-nav-item">
